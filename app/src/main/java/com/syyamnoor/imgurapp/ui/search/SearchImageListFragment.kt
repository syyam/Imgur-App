...
import com.syyamnoor.imgurapp.databinding.FragmentSearchItemListBinding
...
class SearchImageListFragment : Fragment() {
    ...
    private lateinit var binding: FragmentSearchItemListBinding

    private val imageListViewModel: SearchImageListViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        binding = FragmentSearchItemListBinding.inflate(inflater, container, false)
        ...
        imageAdapter = ImageAdapter { _, image ->
            imageListViewModel.performEvent(
                SearchImageListViewModel.ListUiEvent.Search(
                    "cat"
                )
            )
        }
    ...
    private fun performQuery() {
        imageListViewModel.performEvent(SearchImageListViewModel.ListUiEvent.Refresh)
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        searchView.setOnCloseListener {
            imageListViewModel.performEvent(SearchImageListViewModel.ListUiEvent.Search(""))
            false
        }
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                imageListViewModel.performEvent(SearchImageListViewModel.ListUiEvent.Search(newText))
                return true
            }
        })
